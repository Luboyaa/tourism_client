      ...
      <div class="form-database-form">
        ...
        >
          ...
          <el-form-item
            ...
            prop="yudingshijian"
            required
            :rules="[{ required: true, message: '请填写预订时间' }]"
          >
            <el-date-picker
          ...
          <el-form-item label="预订人姓名" prop="yudingrenxingming">
            <el-input
              placeholder="输入预订人姓名"
              style="width: 250px"
              v-model="form.yudingrenxingming"
            />
          </el-form-item>
    ...
    submit() {
      this.$refs.formModel
        ...
        .then((res) => {
          ...
          this.$post(api.yuding.insert, form)
            .then((res) => {
              this.loading = false;
